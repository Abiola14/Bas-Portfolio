<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AboutWebPage.aspx.cs" Inherits="AboutWebPage" %>
    ...
    <section class="about_area section_gap">
        <div class="container">
            <div class="row justify-content-start align-items-center">
                <div class=" col-lg-5">
                    <div class="about_img">
                        <img style="border-radius: 1200px" src="/img/me1.jpg" />
                    </div>
                </div>
...
and maintenance of web systems.  Proficient in an assortment of 
technologies, including  ASP.NET, C# and Microsoft SQL Server. Able 
to effectively self-manage during independent projects, as well as 
collaborate in a team settings
                        </p>
                ...
                <div class="offset-lg-2 col-lg-4 col-md-6">
                    <div class="client-info">
                        ...
                        <div class="call-now d-flex">
                            ...
                            <div class="ml-15">
                                <p>call us now</p>
                                <h3 style="text-align: center">0805-401-8142</h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="testi_slider owl-carousel">
                    <div class="testi_item">
                        <div class="row">
                            <div class="col-lg-4">
                                <img runat="server" id="Image1" src="" alt="" />
                            </div>
                            <div class="col-lg-8">
                                <div class="testi_text">
                                    <h4 runat="server" id="Image1Name"></h4>
                                    <p runat="server" id="Image1Desc"></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="testi_item">
                        <div class="row">
                            <div class="col-lg-4">
                                <img runat="server" id="Image3" src=" /img/testimonials/t1.jpg" alt=" your image" />
                            </div>
                            <div class="col-lg-8">
                                <div class="testi_text">
                                    <h4 runat="server" id="Image3Name"></h4>
                                    <p runat="server" id="Image3Desc"></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="testi_item">
                        <div class="row">
                            <div class="col-lg-4">
                                <img runat="server" id="Image4" src="" alt="" />
                            </div>
                            <div class="col-lg-8">
                                <div class="testi_text">
                                    <h4 runat="server" id="image4Name"></h4>
                                    <p runat="server" id="Image4Desc"></p>
                                </div>
                            </div>
                        </div>
                    </div>
